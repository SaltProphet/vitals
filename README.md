...
Portable live utilization monitor for **this PC**: CPU (per core), memory, disk, network, uptime, and thermal when Windows exposes a sensor.

No installer. Nothing is sent off the machine.

## Download (Windows 10/11, 64-bit)

**[Get Vitals 1.0.0](https://github.com/SaltProphet/vitals/releases/latest)**

1. Download `Vitals-1.0.0-windows-x64.zip`
2. Unzip anywhere
...
```
674bd4b538969afdcd4cc058fce63d14f12bd5740ad9ebb2a85d5a4dc031e7c2  Vitals.exe
```
